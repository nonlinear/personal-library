...
- Original v0.5.0 was just data prep, now includes delta optimization
...
- ✅ Indexing scripts extract page/chapter during chunking
- ✅ chunks.json stores new metadata fields
- ✅ Backward compatibility (old chunks still work)
- ❌ NO changes to research.py output format
- ❌ NO changes to citation display
