...
**Core concept:** **Knowledge Compounding** - Each validated finding builds on previous work, creating exponentially growing expertise over time.
...
- Blog section listing all knowledge gaps discovered
- Automated index of PRIMARY SOURCE findings
- Portfolio of unique contributions to collective knowledge
...
If finding relates to a **different** epic than current branch:

**Ask user:**

```
📋 Current branch: v0.6.0
📋 Finding relates to: VS Code pill validation (v0.4.0)

Findings aren't inherent to branches - just discovered during them.

Should I:
1. Update v0.4.0 epic notes (finding belongs there thematically)
2. Document in v0.6.0 (found here, but less organized)
3. Both (cross-reference between epics)

Recommendation: Update v0.4.0 - keeps knowledge organized by topic
```

**Example scenario:**

- Working on v0.6.0 (Citations 2.0)
- Discover new pill validation edge case
- Should update v0.4.0/pill-validation.md (thematic home)
- Add note in v0.6.0: "See v0.4.0 pill findings for related discovery"

**Knowledge Compounding in action:** Later work builds on earlier findings regardless of branch.
